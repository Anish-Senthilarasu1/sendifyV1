This is Version 1 of an email and sms sender application using Python, that fetches API info from both weather and quotes APi to the desired sender. No SMS library was used.
